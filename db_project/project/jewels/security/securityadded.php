...
if(isset($_POST['submit'])){
    ...
    if(empty($_POST['timings'])){

        // Adds name to array
        $data_missing[] = 'timings';
...
//        require_once('../../mysqli_connect.php');
        ...
        $query = "INSERT INTO security (employee_id, company_name, timings) VALUES (?, ?, ?)";
        
        $stmt = mysqli_prepare($dbc, $query);
        
        
        mysqli_stmt_bind_param($stmt, "iss", $employee_id,
                               $company_name, $timings);
...
<form action="http://localhost/project/jewels/security/securityadded.php" method="post">
...
<p>company_name:
<input type="text" name="company_name" size="50" value="" />
</p>

<p>Timings
<input type="text" name="timings" size="50" value="" />
</p>
