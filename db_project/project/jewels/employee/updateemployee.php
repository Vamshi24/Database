...
//$UpdateQuery = "UPDATE `employee` SET `name` = '$_POST[name]', `phone_no` = '$_POST[phone_no]', `houseno` = '$_POST[houseno]', `pincode` = '$_POST[pincode]' `salary` = '$_POST[salary]', `DOB` = '$_POST[DOB]', `age` = '$_POST[age]' WHERE `employee_id` ='$_POST[employee_id]'";
